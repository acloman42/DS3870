...
namespace ISISGetEmployee
{
    public static class getEmployee
    {
            ...
            ILogger log)
        {
            ...
            Employee Archer = new Employee("Archer", "Sterling", "Duchess", "Field Agent", "Active",23.75,18.50,"ISIS");
            Employee Lana = new Employee("Lana", "Kane", "Truckasaurus", "Field Agent", "Active",21.50,23.50,"ISIS");
            Employee Pam = new Employee("Pam", "Poovey", "Snowball", "Human Resources Director", "Active",49.00,12,"ISIS");
